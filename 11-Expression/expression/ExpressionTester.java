...
public class ExpressionTester<E extends ToMiniString, C> extends Tester {
    private final List<Integer> VALUES = IntStream.rangeClosed(-10, 10).boxed()
    ...
    private void checkEqualsAndToString(final String full, final String mini, final ToMiniString expression,
        ...
        for (final Pair<ToMiniString, String> pair : prev) {
            counter.test(() -> {
                ...
                assertTrue("Inconsistent hashCode for " + prev + " and " + expression,
    ...
    protected ExpressionTester<E, C> basicF(final String full, final String mini, final E expected,
    ...
    protected ExpressionTester<E, C> advancedF(final String full, final String mini, final E expected,
            final Function<List<String>, E> actual) {
    ...
    private final class Test {
        ...
        private void test() {
            ...
            counter.test(() -> {
                kind.allValues(variables.size(), VALUES)
                        .forEach(values -> check(mini, expected, actual, names, values));
    ...
    private final class Generator {
        ...
        private void binary(final String name, final int priority, final BinaryOperator<C> op, final Class<?> type) {
            ...
            final Constructor<? extends E> constructor = (Constructor<? extends E>) Arrays
